...
import { PanelFrame } from "./components/layout/panels/PanelFrame";
import { useSocketEvents } from "./hooks/use-socket-events";
import { useDashboardStore } from "./store/use-dashboard-store";
import { usePanelResize, COLLAPSED_PANEL_SIZE } from "./hooks/use-panel-resize";
...
export default function App() {
  ...
  } = usePanelResize(collapsedPanels, expandedPanel);
  ...
  return (
    <div className="flex h-screen flex-col bg-background text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div
          className={cn(
            "fixed inset-y-0 left-0 z-50 w-80 transform transition-transform duration-200 ease-in-out md:relative md:translate-x-0 md:z-auto",
          ...
          <Sidebar onFlowSelect={() => setSidebarOpen(false)}>
            ...
            <div className="flex bg-muted/50 p-1 rounded-md mb-2">
              <button
                ...
                className={cn(
                  "flex-1 text-xs py-1.5 font-medium rounded",
                  currentView === "flows"
            ...
            expandedContent ? (
              ...
              <>
                <div
                  ...
                  style={{
                    height: collapsedPanels.pipeline
