...
SKILL_DIR="$REPO_ROOT"
OUTPUT_FILE="${DEVTEAM_OUTPUT_FILE:-}"
...
# State projection and next-step scheduling are owned exclusively by the
# Inngest worker. The wrapper only executes the runtime and returns its code.
exit $EXIT_CODE
